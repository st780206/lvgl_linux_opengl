...
void lv_demo_widgets(void)
{
    ...
    //LV_LOG_WARN("===== 11111 =========  lv_demo_widgets start.     ");
    ...
    //LV_LOG_WARN("===== 22222 =========  lv_demo_widgets.     ");
    ...
    //LV_LOG_WARN("===== 33333 =========  lv_demo_widgets.     ");
    ...
    //LV_LOG_WARN("===== 44444 =========  lv_demo_widgets.     ");
    ...
    //LV_LOG_WARN("===== 55555 =========  lv_demo_widgets.     ");
    profile_create(t1);
    //LV_LOG_WARN("===== 66666 =========  lv_demo_widgets.     ");
    analytics_create(t2);
    //LV_LOG_WARN("===== 77777 =========  lv_demo_widgets.     ");
    shop_create(t3);

    //LV_LOG_WARN("===== 88888 =========  lv_demo_widgets.     ");

    color_changer_create(tv);

    //LV_LOG_WARN("===== 99999 =========  lv_demo_widgets.     ");
